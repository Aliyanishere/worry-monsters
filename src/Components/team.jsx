                    ...
                    <div className="d-flex align-items-center justify-content-center izc">
                        <div className="left text-start flex-wrap izp px-0 px-lg- px-md-4 mx-0 mx-lg-4 mx-md-4" data-aos="fade-down">
                            ...
                            <p style={{ fontSize: '15px', lineHeight: '22px' }} className="w-100 pt-2 fw-light">
                                Artist, Director and University Acting Teacher with a background in Cognitive Behavioural Therapy and interactive game design. Stephen has decades of experience teaching creativity in emotionally-rich, trauma-informed learning environments, fostering personal growth and transformation. To me, the most important step of any path to improvement is confidence and agency. You have to feel that you can do something before you can talk yourself into trying it.
                            </p>
                        </div>
